...
- [`src/`](./src) — 바로 실행 가능한 [`invisibility_cloak.py`](./src/invisibility_cloak.py)와 코드 원본([PDF](./src/컴퓨터%20비전%206조%20코드.pdf), [HWP](./src/컴퓨터%20비전%206조%20코드.hwp))
